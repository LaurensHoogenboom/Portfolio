...
export const load = (async () => {
    const [recentLogins, totalUserCount, mostViewedPortfolioItems] = await Promise.all([
    ...
    return { recentLogins: recentLogins, totalUserCount: totalUserCount, mostViewedPortfolioItems: mostViewedPortfolioItems };
